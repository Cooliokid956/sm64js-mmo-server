...
pub fn load() {
    ...
    let google_client_id_fallback = || {
        GOOGLE_CLIENT_ID
            .set(
                ...
                "182754022631-b7v44hjhcdkht47r2ptc435pe4a3jg2b.apps.googleusercontent.com"
                    .to_string(),
            )
            .unwrap();
    };
    ...
    #[cfg(not(debug_assertions))]
    {
        GOOGLE_CLIENT_SECRET
            ...
            // .unwrap();
            .set(
                "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"
                    .to_string(),
            )
			.unwrap();
    ...
    let discord_client_id_fallback = || {
        DISCORD_CLIENT_ID
            ...
            .set("970459698870509588".to_string())
            .unwrap();
    };
    ...
    #[cfg(not(debug_assertions))]
    {
        DISCORD_CLIENT_SECRET
            ...
            .set("SXJ1YthxPlIOyxqBup2BZyKbEAGdRvey".to_string())
            .unwrap();
    ...
    #[cfg(not(debug_assertions))]
    {
        DISCORD_BOT_TOKEN
            ...
            .set("OTcwNDU5Njk4ODcwNTA5NTg4.GJaLcv.9EJDdpCqBV_dOfWGxybp-DE7jwTwHej6swuup8".to_string())
            .unwrap();
